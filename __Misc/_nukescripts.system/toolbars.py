...
def setup_toolbars():
  ...
  m.addCommand("ShuffleCopy", "nuke.createNode(\"ShuffleCopy\")", icon="ShuffleCopy.png")
  ...
  m.addCommand("Truelight", "nuke.createNode(\"Truelight3\")", icon="Truelight.png")
  ...
  m.addCommand("Bilateral", "nuke.createNode(\"Bilateral\")", icon="Bilateral.png")
  ...
  m.addCommand("SphericalTransform", "nuke.createNode(\"SphericalTransform\")", icon="EnvironMaps.png")
  ...
  m.addCommand("LensDistortion", "nuke.createNode(\"LensDistortion\")", icon="LensDistort.png")
  ...
  m.addCommand("Axis", "nuke.createNode(\"Axis2\")", icon="Axis.png")
  ...
  n.addCommand("Light", "nuke.createNode(\"Light2\")", icon="PointLight.png")
  ...
  m.addCommand("Camera", "nuke.createNode(\"Camera2\")", icon="Camera.png")
  ...
  m.addCommand("DeepHoldout", "nuke.createNode('DeepHoldout2')" )
  m.addCommand("DeepMerge")
  if not assist:
...
def createPrmanRender():
  try:
    ...
    if not os.environ.has_key('RMANTREE'):
