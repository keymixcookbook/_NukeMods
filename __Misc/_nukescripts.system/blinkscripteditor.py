...
class ScriptInputArea(PySide.QtGui.QPlainTextEdit, PySide.QtCore.QObject) :
    ...
    userChangedEvent = PySide.QtCore.Signal()
    ...
    def getFontFromHieroPrefs(self):
        ...
        from hiero.ui import ApplicationSettings
    ...
    def getFontFromNukePrefs(self):
        ...
        font = PySide.QtGui.QFont(nuke.toNode("preferences").knob("ScriptEditorFont").value())
    ...
    def showEvent(self, event):
        PySide.QtGui.QPlainTextEdit.showEvent(self, event)
        ...
        while (block.isValid() and top <= event.rect().bottom()) :
            ...
            if (block.isVisible() and bottom >= event.rect().top()) :
                ...
                if ( blockNumber == currentLine ) :
                    ...
                    painter.setPen(PySide.QtGui.QColor(35, 35, 35))
                    font.setBold(False)
                    painter.setFont(font)
    ...
    def keyPressEvent(self, event) :
        ...
        lScriptEditorMod = ((event.modifiers() and (PySide.QtCore.Qt.ControlModifier or PySide.QtCore.Qt.AltModifier)) == PySide.QtCore.Qt.ControlModifier)
        lScriptEditorShift = ((event.modifiers() and (PySide.QtCore.Qt.ShiftModifier)) != 0)
        lKey = event.key()
        ...
        if not self._completerShowing :
            if (lScriptEditorMod and (lKey == PySide.QtCore.Qt.Key_Return or lKey == PySide.QtCore.Qt.Key_Enter)) :
              if (self._editor) :
                self._editor.runScript()
              return
            #elif lScriptEditorMod and lScriptEditorShift and lKey == PySide.QtCore.Qt.Key_BraceLeft :
            #    self.decreaseIndentationSelected()
            #    return
            #elif lScriptEditorMod and lScriptEditorShift and lKey == PySide.QtCore.Qt.Key_BraceRight :
            #    self.increaseIndentationSelected()
            #    return
            elif lScriptEditorMod and lKey == PySide.QtCore.Qt.Key_Slash :
                self.commentSelected()
                return
            elif lScriptEditorMod and lKey == PySide.QtCore.Qt.Key_Backspace :
                self._editor.clearOutput()
                return
            elif lKey == PySide.QtCore.Qt.Key_Tab or (lScriptEditorMod and lKey == PySide.QtCore.Qt.Key_Space) :
                #Ok.
            ...
            tc = self.textCursor()
            if lKey == PySide.QtCore.Qt.Key_Return or lKey == PySide.QtCore.Qt.Key_Enter :
                self.insertCompletion(self._currentCompletion)
                self._currentCompletion = ""
                self._completer.popup().hide()
                self._completerShowing = False
            elif lKey == PySide.QtCore.Qt.Key_Right or lKey == PySide.QtCore.Qt.Key_Escape:
                self._completer.popup().hide()
                self._completerShowing = False
            elif lKey == PySide.QtCore.Qt.Key_Tab or (lScriptEditorMod and lKey == PySide.QtCore.Qt.Key_Space) :
                self._currentCompletion = ""
    ...
    def commentSelected(self) :
        ...
        if tc.hasSelection() :
            ...
            if self.document().characterAt(start) == '#' :
              ...
              #   tc.movePosition(PySide.QtGui.QTextCursor.NextBlock, PySide.QtGui.QTextCursorMoveAnchor)
              ...
              #     tc.deleteChar()
              #     prevPosition = tc.position()
              #     tc.movePosition(PySide.QtGui.QTextCursor.NextBlock, PySide.QtGui.QTextCursor.MoveAnchor)
    ...
    def ExtendSelectionToCompleteLines(self, tc) :
        ...
        if (lPos >= lAnchor) :
          ...
          tc.movePosition(PySide.QtGui.QTextCursor.StartOfLine)
          tc.setPosition(lPos, PySide.QtGui.QTextCursor.KeepAnchor)
          #Don't extend if the position was at the beginning of a new line
          lSelected = tc.selectedText()
          if lSelected != "" and lSelected[-2:-1] != "\n" :
            tc.movePosition(PySide.QtGui.QTextCursor.EndOfLine, PySide.QtGui.QTextCursor.KeepAnchor)
          ...
          tc.movePosition(PySide.QtGui.QTextCursor.PreviousCharacter,PySide.QtGui.QTextCursor.KeepAnchor)
          lSelected = tc.selectedText()
          tc.movePosition(PySide.QtGui.QTextCursor.NextCharacter)
          if lSelected != "" and lSelected[-2:-1] != "\n" :
            tc.movePosition(PySide.QtGui.QTextCursor.EndOfLine)
          tc.setPosition(lPos, PySide.QtGui.QTextCursor.KeepAnchor)
          tc.movePosition(PySide.QtGui.QTextCursor.StartOfLine, PySide.QtGui.QTextCursor.KeepAnchor)
    ...
    def increaseIndentationSelected(self) :
        ...
        if tc.hasSelection() :
            ...
            tc.setPosition(start)
            tc.setPosition(end, PySide.QtGui.QTextCursor.KeepAnchor)
...
class InputHighlighter(PySide.QtGui.QSyntaxHighlighter) :
    def __init__(self, doc, parent=None):
        ...
        self._blinkFuncs = PySide.QtGui.QTextCharFormat()
        self._blinkTypes = PySide.QtGui.QTextCharFormat()
        ...
        #self._blinkFuncs.setFontWeight(PySide.QtGui.QFont.Bold)
        ...
        #self._blinkTypes.setFontWeight(PySide.QtGui.QFont.Bold)
