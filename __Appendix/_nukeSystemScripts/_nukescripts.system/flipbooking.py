...
class FlipbookFactory(object):
  ...
  def isRegistered(self, flipbook):
    ...
    @return: bool"""
    return self._flipbookApplications.has_key(flipbook.name())
  ...
  def getNames(self):
    ...
    @return: list"""
    return self._flipbookApplications.keys()
  ...
  def getApplication(self, name):
    ...
    if self._flipbookApplications.has_key(name):
...
class FlipbookLUTPathRegistry(object):
  ...
  def registerLUTPathForFlipbook(self, flipbook, lut, path):
    ...
    if not self._luts.has_key(flipbook):
      self._luts[flipbook] = {}
